  ...
  return (
    <div className="min-h-screen bg-blue-50 p-5 text-black w-full">
      ...
      {filteredProducts.length > 0 ? (
        ...
        {/* Top Cities Section */}
        <div className="bg-white p-4 rounded-md shadow w-[203px] h-[371px] mt-12 ">
          ...
          <button className="mt-4 bg-gray-200 px-4 py-1 w-32 h-8 rounded-md items-center ">Load More</button>
