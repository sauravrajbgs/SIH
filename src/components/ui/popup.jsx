...
export const Popup = ({ isPopUpOpen, togglePopUp, children }) => {
  ...
  return createPortal(
    ...
    >
      <div className="relative flex flex-col space-y-1 w-[80vw] md:h-[100vh] h-[80vh] overflow-auto p-6 shadow-lg">
        {/* Close button */}
        ...
        {/* Popup content */}
        <div className="bg-[#191c1e] relative w-auto md:max-h-[85vh] max-h-[60vh] overflow-auto p-6 scrollbar-hide">
          <div>{children}</div>
        </div>
      </div>
    </div>,
